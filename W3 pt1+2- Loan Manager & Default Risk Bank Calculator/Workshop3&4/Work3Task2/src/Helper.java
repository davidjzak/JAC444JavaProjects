...
public class Helper {
	...
	private  List <String> yesList = Arrays.asList("yes", "Yes", "YES", "y", "Y", "Ye", "YE" );
	private  List <String> noList = Arrays.asList("n", "N", "no", "NO", "No", "nO");
...
public static char getChar(){
	...
	public boolean yesOrNo(String doMessage) {
